          ...
          <div class="row g-0">
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form class="user" method="POST" action="register_action.php" id="contactForm" enctype="multipart/form-data" >



                  <h2 style="text-align: center; color: #d8363a;">Contractor Registration</h2>

 <div align="center" style="color:red;"><?php
    if(isset($_GET['alert'])) echo $_GET['alert'];
    ?></div>
             
                  <div  class="form-outline mb-4"><strong>Application Type:</strong>


                                    <select   class="form-control"  id="app" name="app" required>
                                         <option value="individual" >select</option>
  <option value="individual" >Individual</option>
  <option value="Company/Firm" >Company/Firm</option>
                                ...
                                <div class="form-outline mb-4"><strong>Company owner/Applicant Name:</strong> 
    ...
    return true;
                                   ...
                                   ?>
                                    ...
                                    <!--<div class="form-outline mb-4">Date Of Birth
                                        <input type="date" class="form-control "
                                           name="dob" id="dob" onchange="myFunction;" min="1977-01-01" max="1997-12-30" required>
                        ...
                        function myFunction() 
                    {
                        ...
                        document.getElementById("dob").innerHTML = "Invalid Date!!";
                                    ...
                                    <div class="form-outline mb-4"> Company owner/Applicant Pancard Number
...
document.getElementById('msg4').innerHTML=" ";
    return true;
                                    ...
                                    <div class="form-outline mb-4">Image Upload of owner:
...
document.getElementById('msg15').innerHTML=" ";
    return true;
                                     ...
                                     <div class="form-outline mb-4">Other Certificates:
...
document.getElementById('msg16').innerHTML=" ";
    return true;
                                                                     ...
                                                                     <div class="form-outline mb-4">Contractor License Certificate Upload:
...
<div class="text-center pt-1 mb-5 pb-1">
            ...
            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
              ...
              <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                 ...
                 <strong><h4 class="mb-4">Welcome to Contractor Registartion</h4></strong>
