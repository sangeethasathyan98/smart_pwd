...
<body id="page-top">
                            ...
                            <div class="form-group">
                                   <!-- <label for="Name" class="col-sm-2 control-label">Tender</label>-->
                                    <div style="text-align: center; margin-left: 132px;" class="col-sm-8">
                                                                            <select class="form-control1" name="tenders" id="focusedinput"  required="">
 ...
 $uma=$r['Userid'];
//echo "select * from registration where email='$uma'";
$qss=  mysqli_query($con, "select * from registration where email='$uma'");
