 ...
 <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 align="center" style="color:blue;"><strong>View Completed Projects</strong></h6>
                        </div>
...
<th>District</th>
         ...
         $qj=  mysqli_query($con, "select * from work_progress where status_work='Completed' and stage='Stage 4'");
