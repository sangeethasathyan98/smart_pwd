 ...
 <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="tab-pane active" id="horizontal-form" >
                                                    ...
                                                    action="addcategory_action.php" >
                                      <div > s<div align="center" style="color:red; text-align: center;"><?php
    ...
    ?></div>
                            ...
                            <div align="center" class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="category" id="category" value="" required="">
                                    </div>
