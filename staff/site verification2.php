...
<body id="page-top">
    ...
    <div id="wrapper">
      ...
      include './header.php';
              ?>
                <!-- End of Topbar -->
<h4><a href="siteverification11.php">Back</a></h4>
                <!-- Begin Page Content -->
 ...
 <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 align="center" style="color:blue;"><strong>View Projects work progress</strong></h6>
                        </div>
  ...
  <table border="1" style="width: 100%">
         ...
         $qj=  mysqli_query($con, "select * from work_progress where tender_id='$id'");
          ...
          ?>
                                            ...
                                            <tr><td><a  href="viewtenderdetails1.php"><?php echo $r11['oder_no'];?></a></td>
                                                  ...
                                                  <td><a class="btn btn-primary" href="siteinspection.php?id=<?php echo $r1['work_id'];?>&&tid=<?php echo $tid ?>">Site Inspection</a></td>
