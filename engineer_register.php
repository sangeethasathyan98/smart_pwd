          ...
          <div class="row g-0">
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form class="user" method="POST" action="engineer_register_action.php" id="contactForm" enctype="multipart/form-data" >



                  <h4 style="text-align: center; color: #d8363a;">Engineer Registration</h4>
...
document.getElementById('msg4').innerHTML=" ";
 ...
 <div  class="form-outline mb-4"><strong>Education Qualification:</strong>
  ...
  <option value="Btech(Civil Engineering)" > Degree(Civil Engineering)</option>
...
<div class="text-center pt-1 mb-5 pb-1">
            ...
            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
              ...
              <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                 ...
                 <strong><h4 class="mb-4">Welcome to Engineer Registration</h4></strong>
