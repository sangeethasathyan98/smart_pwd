    ...
    ?></div>
        ...
        ?> -->            
            ...
            <div class="form-group">
             ...
             <div class="col-sm-8">
              <input type="text" class="form-control-user form-control" name="title" id="focusedinput" value="<?php echo $r['Title']; ?>" >
            </div>
          ...
          <div class="form-group">
           ...
           <div class="col-sm-8">
            <textarea class="form-control-user form-control" name="rules" id="focusedinput" value="" ><?php echo $r['Rules']; ?></textarea>
          </div>
           <div class="form-group"><br>
          <label class="Name">Tender Amount</label>
           <div class="col-sm-8">
            <input type="number" class="form-control-user form-control" name="amount" id="focusedinput" value="<?php echo $r['t_amount']; ?>" >
          </div>
        </div>
         <div class="form-group"><br>
          <label class="Name">Period Of Completion</label>
           <div class="col-sm-8">
            <input type="text" class="form-control-user form-control" name="period" id="focusedinput" value="<?php echo $r['period_completion']; ?>" >
          </div>
        </div>
        <div class="form-group">
       <label class="Name">Last Date To Apply</label>
         <div class="col-sm-8">
          <input type="date" class="form-control-user form-control" name="ldate" id="focusedinput" value="<?php echo $r['Ldate']; ?>" >
        </div>
         <div class="form-group">
         <label for="Name" class="col-sm-2 control-label">Bid Opening Date</label>
         <div class="col-sm-8">
          <input type="date" class="form-control-user form-control" name="bdate" id="focusedinput" value="<?php echo $r['bid_open']; ?>" >
        </div>
...
$period=$_POST['period'];
  ...
  $query="update tender set Title='$title',Rules='$rules',t_amount='$amount',period_completion='$period' ,Ldate='$ldate',bid_open='$bdate' where Id=$id";
 ...
 echo "<script>location='addtenderview.php?show=UPDATED  SUCCESSFULLY......!'</script>";
  }
}
?>
