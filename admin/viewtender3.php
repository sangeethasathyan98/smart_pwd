...
//$id=$_GET['r_id'];
//$qr11=  mysqli_query($con, "select * from registration where r_id='$id'");
           // $r=mysqli_fetch_array($qr11);
...
<td><?php echo $r['Description'];?></td>
                ...
                <td>   <a class="btn-info btn"   href="viewtenderdetails1.php?id=<?php echo $r['Id'];?>">View Application</a>  
                     </td>
