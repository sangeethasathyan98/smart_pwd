...
<!--<div   class="card shadow mb-4">
                        ...
                        <div class="tab-pane active" id="horizontal-form" >--><h1 align="center">View Contractor list</h1>
                            <br>
            ...
            <tbody>
             ...
             <?php 
           $qr="select  *from registration where r_status='Approved' and status='contractor' order by r_id desc";
 ...
 <td>  <a class="btn-info btn"  href="viewcontractor_pdf.php?id=<?php echo $r['r_id'];?>">View Application</a>&nbsp;  <a class="btn-primary btn"  href="viewcontractor_docu.php?id=<?php echo $r['r_id'];?>">View Document</a> </td>
