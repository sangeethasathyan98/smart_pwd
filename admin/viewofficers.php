...
<h1 align="center">View Executive officers list</h1>
                            <br>
            ...
            while($r=mysqli_fetch_array($qrr))
            {
              ...
              <tr>
                <form name="f1" method="post" action="">
                  <td><?php echo $i;?></td>
           <!--<td><a class="btn-light btn" target="_blank" href="../upload/<?php echo $r['education_proof']; ?>">view</a></td>  -->             
            <td><img src="../upload/<?php echo $r['image']; ?>" width="125" height="100"/></td>
               ...
               <!-- <td><img src="../<?php echo $r['image']; ?>" width="100" height="100"/></td>-->
                ...
                <td>  
                    <a class="btn-info btn"  href="viewofficer_pdf.php?id=<?php echo $r['r_id'];?>">View Application</a>&nbsp;


                    <a class="btn-primary btn"  href="viewofficers_docu.php?id=<?php echo $r['r_id'];?>">View Document</a> 
                 <a class="btn-success btn" href="officer_active.php?id=<?php echo $r['r_id'];?>&j=0">Approve</a>&nbsp;  <a class="btn-danger btn" href="officer_active.php?id=<?php echo $r['r_id'];?>&j=1">Reject</a>          </td>
