...
<h1 align="center">View Engineers list</h1>
            ...
            <tbody>
             ...
             <?php 
           $qr="select  *from registration where status='engineer'  order by r_id desc";
            ...
            while($r=mysqli_fetch_array($qrr))
            {
              ...
              <tr>
                ...
                <td>  <a class="btn-info btn"  href="viewengineer_app.php?id=<?php echo $r['r_id'];?>">View Application</a>&nbsp;  <a class="btn-primary btn"  href="viewengineer_docu.php?id=<?php echo $r['r_id'];?>">View Document</a>   <a class="btn-success btn" href="engineer_active.php?id=<?php echo $r['r_id'];?>&j=0">Approve</a>&nbsp;  <a class="btn-danger btn" href="engineer_active.php?id=<?php echo $r['r_id'];?>&j=1">Reject</a>          </td>
