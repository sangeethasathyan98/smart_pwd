...
<body id="page-top">
                      ...
                      <h2 align="center">View tender  Details</h2>
                        ...
                        <tbody>
                          <?php
                                                  ...
                                                  $qr="select * from tender  where status='0'";
 ...
 <td><?php echo $r['oder_no'];?></td>
                                                        ...
                                                        <td><?php echo $r['Title'];?></td>
                                                         ...
                                                         <a href="tenderunblock.php?id=<?php echo $r['Id'];?>"><input type="button" class="btn-success btn" name="btn" value="Unblock" onclick="alert('are you sure want to unBlock??')"> </a>
                                                     </td>
