 ...
 <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 align="center" style="color:blue;"><strong>Apply Quotation</strong></h6>
                        </div>
  ...
  <table border="1" style="width: 100%">
          ...
          ?>
                                            ...
                                            <tr>  <td><?php echo $r1['oder_no'];?></td> 
                                             <td><?php echo $r1['Type'];?></td> 
                                              <td><?php echo $r1['district'];?></td> 
                                                <td><?php echo $r1['Title'];?></td> 
                                                
                                                    <td><?php echo $r1['Rules'];?></td> 
                                                 <td><?php echo $r1['t_amount'];?></td>
                                                    <td><?php echo $r1['Ldate'];?></td> 

                                                     <td><?php echo $r1['bid_open'];?></td> 
                                                   <!--<td><a class="btn btn-style btn-success" href="calculate_amont.php?id=<?php echo $r1['Id'];?>">Calculate Estimated Budget</a>
                                                    
                                                   </td>-->
                                                   <td>
                                                    <a class="btn btn-style btn-primary" href="tender.php?id=<?php echo $r1['Id'];?>"> Apply Now</a>
                                                   </td>
                                            </tr>
                                             <?php 
                                 }
