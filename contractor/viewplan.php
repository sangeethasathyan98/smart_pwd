  ...
  ?>
   ...
   <div class="w3l-table-info" style="overflow-x: auto;">
                    <br>
                            ...
                            <h4 align="center" style="color:blue;"><strong>View Accepted Project plans</strong></h4><br>
                     <br>
            ...
            <tbody>
             ...
             <?php
                                                  ...
                                                  $qr="select * from qutation where r_id='$uid' and Tender='Approved'";
...

{
   ...
   $tid=$r['Tenderid'];
                $qr=  mysqli_query($con, "select * from tbl_plan where Id='$tid'");
              ...
              $qr11=  mysqli_query($con, "select * from tender");
              ...
              <tr>
                <form name="f1" method="post" action="">
                  ...
                  <td><a class="btn-info btn" target="_blank" href="../upload/<?php echo $r1['Proof']; ?>">view</a></td>
