 ...
 <div class="container-fluid">
  ...
  <form class="form-contact " action="" method="POST" id="" novalidate="novalidate" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-3">
                                <input type="submit" class="button boxed-btn" name="submit" value="UPDATE">
                            </div>
                    ...
                    if(isset($_POST['submit']))
                    {
                        ...
                        $path="../admin/proof/".$image;
                        $path1="proof/".$image;
                        move_uploaded_file($timage,$path);
                     $qr1=mysqli_query($con,"update qutation set Proof='$path1' where Id='$id'");
                      if($qr1)
                        {
